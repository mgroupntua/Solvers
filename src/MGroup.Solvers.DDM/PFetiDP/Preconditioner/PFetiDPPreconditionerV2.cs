namespace MGroup.Solvers.DDM.PFetiDP.Preconditioner
{
	...
	public class PFetiDPPreconditionerV2 : IPsmPreconditioner, IPreconditioner
	{
		private readonly IComputeEnvironment environment;
		private readonly IFetiDPCoarseProblem coarseProblem;
		private readonly Func<int, FetiDPSubdomainMatrixManagerSymmetricCscV2> getFetiDPSubdomainMatrices;
		...
		public PFetiDPPreconditionerV2(IComputeEnvironment environment, Func<DistributedOverlappingIndexer> getBoundaryDofIndexer,
			IBoundaryDofScaling scaling, Func<int, FetiDPSubdomainMatrixManagerSymmetricCscV2> getFetiDPSubdomainMatrices,
		...
		public void Apply(IGlobalVector input, IGlobalVector output)
		{
			...
			{
				FetiDPSubdomainMatrixManagerSymmetricCscV2 fetiDPMatrices = getFetiDPSubdomainMatrices(subdomainID);
				...
				//Vector v4 = fetiDPMatrices.MultiplyKcrTimes(fetiDPMatrices.MultiplyInverseKrrTimes(Nrb.Multiply(v1, false)));
				Vector v4 = fetiDPMatrices.MultiplyKcrTimesInverseKrrTimes(Nrb.Multiply(v1, false));
				Vector yc = v2 - v4;
			...
			environment.DoPerNode(subdomainID =>
			{
				...
				Vector v6 = fetiDPMatrices.MultiplyInverseKrrTimesKrcTimes(xc);
				Vector v7 = v3 - v6;
