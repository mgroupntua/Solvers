...
namespace MGroup.Solvers.DomainDecomposition.Dual.FetiDP
{
    public class FetiDPDofSeparator : DofSeparatorBase
    {
        ...
        /// </summary>
        public void CalcCornerMappingMatrices(IModel model, Dictionary<int, HashSet<INode>> subdomainCornerNodes)
        ...
        public void DefineGlobalBoundaryDofs(IModel model, Dictionary<int, HashSet<INode>> subdomainCornerNodes)
        {
        ...
        public void DefineGlobalCornerDofs(IModel model, Dictionary<int, HashSet<INode>> subdomainCornerNodes)
        {
