...
namespace MGroup.Solvers.Tests.DomainDecomposition.Dual.Feti1
{
	...
	public static class SimplePlateTest
	{
		...
		internal static void Run()
		{
			...
			(IVectorView computedDisplacements, ISolverLogger logger) =
		...
		private static (IVectorView U, ISolverLogger logger) SolveModelWithSubdomains(int numElementsX, int numElementsY,
