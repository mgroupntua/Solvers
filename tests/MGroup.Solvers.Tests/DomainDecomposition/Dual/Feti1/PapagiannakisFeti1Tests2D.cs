...
namespace MGroup.Solvers.Tests.DomainDecomposition.Dual.Feti1
{
	...
	public static class PapagiannakisFeti1Tests2D
	{
			...
			Residual convergence, int iterExpected)
		{
			...
			(IVectorView ddDisplacements, ISolverLogger logger, int numUniqueGlobalDofs, int numExtenedDomainDofs) =
		...
		private static (IVectorView globalDisplacements, ISolverLogger logger, int numUniqueGlobalDofs, int numExtenedDomainDofs)
